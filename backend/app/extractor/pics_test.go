...
func TestExtractPics(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, "https://p.umputun.com/images/posts/n891a_20150925_023343-minwz.png", a.Image)
	assert.Equal(t, 3, len(a.AllImages))
	assert.Equal(t, "https://p.umputun.com/images/posts/apple-maps-app-220-100.jpg", a.AllImages[0])
	assert.Equal(t, "https://p.umputun.com/images/posts/ios9nav-heavytraffic-6c-1.jpg", a.AllImages[1])
	assert.Equal(t, "https://p.umputun.com/images/posts/n891a_20150925_023343-minwz.png", a.AllImages[2])
}
